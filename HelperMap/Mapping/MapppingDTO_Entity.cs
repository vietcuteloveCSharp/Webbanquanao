...
{
    public class MapppingDTO_Entity:Profile
    {
       public MapppingDTO_Entity() 
        {
            ...
            CreateMap<PhuongThucThanhToanDTO, PhuongThucThanhToan>()
            ...
            CreateMap<ThanhToanHoaDonDTO, ThanhToanHoaDon>()
                 .ForMember(dto => dto.TongTien, entity => entity.MapFrom(src => src.TongTien))
